<?php
if ( ! function_exists('init_games') ) {

// Register Custom Post Type
function init_games() {

	$labels = array(
		'name'                  => _x( 'Games', 'Post Type General Name', 'jawn_games' ),
		'singular_name'         => _x( 'Game', 'Post Type Singular Name', 'jawn_games' ),
		'menu_name'             => __( 'Games', 'jawn_games' ),
		'name_admin_bar'        => __( 'Game', 'jawn_games' ),
	...
	$args = array(
		'label'                 => __( 'Game', 'jawn_games' ),
		'description'           => __( 'It is a game.', 'jawn_games' ),
		'labels'                => $labels,
	...
	register_post_type( 'jg_game', $args );

}
add_action( 'init', 'init_games', 0 );
