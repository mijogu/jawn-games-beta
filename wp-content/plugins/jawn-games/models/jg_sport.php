<?php
if ( ! function_exists('init_sports') ) {

// Register Custom Post Type
function init_sports() {

	$labels = array(
		'name'                  => _x( 'Sports', 'Post Type General Name', 'jawn_games' ),
		'singular_name'         => _x( 'Sport', 'Post Type Singular Name', 'jawn_games' ),
		'menu_name'             => __( 'Sports', 'jawn_games' ),
		'name_admin_bar'        => __( 'Sport', 'jawn_games' ),
	...
	$args = array(
		'label'                 => __( 'Sport', 'jawn_games' ),
		'description'           => __( 'It is a sport.', 'jawn_games' ),
		'labels'                => $labels,
	...
	register_post_type( 'jg_sport', $args );

}
add_action( 'init', 'init_sports', 0 );
